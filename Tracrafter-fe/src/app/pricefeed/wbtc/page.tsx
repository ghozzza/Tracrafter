...
import { factory, mockWbtc, priceFeed } from "@/constants/addresses";
...
const page = () => {
  ...
  const handlePrice = () => {
    fetchData("https://min-api.cryptocompare.com/data/price?fsym=BTC&tsyms=USD")
      .then((data) =>
        writeTransaction({
          abi: priceAbi,
          address: priceFeed,
          functionName: "addPriceManual",
          args: ["WBTC/USD", mockWbtc, data?.USD * 10 ** 8, 8],
        })
      )
